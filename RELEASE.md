...
## What's Changed
- Auto-reset system battery stats on charger unplug, full charge, and reboot.
...
- T2: Add monochrome app icon layer for Android 13+ theming.
- T3: Add scroll to menu drawer for landscape cut-off fix.
